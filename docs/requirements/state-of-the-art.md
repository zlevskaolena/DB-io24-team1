...
| :---           |    :---                                             | :---         | :---         |:---      | :---           | :---         | :---           |
| Functionality  |   Наявність шаблонів опитування                       | 🟩          | 🟩           |🟥       | 🟨             | 🟩          | 🟩             | 
...
| Usability      | Інтуїтивно зрозумілий інтерфейс                     | 🟩          | 🟩           |🟨       | 🟩             | 🟩          | 🟩             |
...
| Performance    | Можливість поділитися опитуванням через соц.мережі  | 🟩          | 🟩           |🟥       | 🟩             | 🟩          | 🟩             |
| Supportability | Можливості інтеграції                               | 🟩          | 🟩           |🟩       | 🟩             | 🟩          | 🟩             |
|           | Режими роботи                                       | Дельфі       | Дельфі       |Дельфі    | Дельфі, мозковий штурм       | Дельфі       | Дельфі, мозковий штурм       |
